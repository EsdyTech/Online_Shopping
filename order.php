    ...
    <div id="background">
        ...
        <div id="page">
                                            ...
                                            <li class="span12">
                                                <div class="thumbnail">
                                                    ...
                                                    <form class="form-horizontal" method="post">
                                                        <div class="alert alert-success"><strong>Daslat Customer Login Form</strong></div>
           ...
           <button type="submit" class="btn btn-primary" name="login"><i class="icon-signin icon-large"></i>&nbsp;Sign in</button>
                                     ...
                                     $query = mysqli_query($con,"select * from tb_member where Email='$username' and Password='$password' ") or die(mysqli_error());
