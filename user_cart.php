...
<body>
            ...
            <div id="content">
             ...
             $product_query = mysqli_query($con,"select * from tb_products where productID='$product_id'") or die(mysqli_error());
                                        $product_row = mysqli_fetch_array($product_query);
										 $prodqty= $product_row['quantity'];
										 $qtty=$prodqty+$cartqty;
                                        ?>
  ...
  <a class="btn btn-danger" href="romove_item.php<?php echo '?id=' . $order_id; echo '&qty=' . $qtty;echo '&pid=' . $product_id; ?>" ><i class="icon-check icon-large"></i>&nbsp;Yes</a>
