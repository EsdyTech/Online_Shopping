            ...
            <div id="content">
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <ul class="thumbnails">
                            <?php
                            $query = mysqli_query($con,"select * from tb_products WHERE category = '$_GET[catid]'") or die(mysqli_error());
             ...
             <a  href="#<?php echo $id; ?>"   data-toggle="modal"><img src="admin/<?php echo $row['location'] ?>" class="img-rounded" alt="" width="50" height="50"></a>
                         ...
                         <a href="#add<?php echo $id; ?>"   data-toggle="modal" class="btn btn-success"><i class="icon-shopping-cart icon-large"></i>&nbsp;Add to Cart</a>
                                    ...
                                    if (isset($_POST['order'])) {
										...
										$totall=$qty-$quantity;
mysqli_query($con,"insert into order_details (memberID,qty,price,productID,total,status,modeofpayment,transaction_code) values('$member_id','$quantity','$price','$product_id','$total','Pending','','')") or die(mysqli_query());
