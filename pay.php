...
/* mysqli_query("update order_details set status='Pending',transaction_code='$confirmation',modeofpayment='Online' where MemberID='$get_id'")or die(mysqli_error());
 */
...
<body>
    ...
    <div id="background">
        ...
        <div id="page">
            <div id="sidebar">
                <a href="user_index.php" class="logo"><img src="images/shop.jpg" alt=""></a>
                <ul>
                    <li class="">
                    ...
                    <div id="body">
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr"  method="post">
                           ...
                           <?php } ?>
                            ...
                            <?php
                            if ($cart_count != 0) {
                                $result = mysqli_query($con,"SELECT sum(total) FROM order_details WHERE memberID='$ses_id' and status = ''") or die(mysqli_error());
