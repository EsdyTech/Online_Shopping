...
<br>
       ...
       <?php include ('nav_sidebar.php');?>
        ...
        <div id="page-wrapper" >
                    ...
                    <div class="col-md-5 well">
                        <div class="hero-unit-table">   
                          <div class="hero-unit-table">   
                            ...
                            $query = mysqli_query($con,"select * from tb_products where productID='$get_id'") or die(mysqli_error());
            ...
            if ($num > 0){
              echo ' <select type="text" required name="category" class = "form-control" placeholder="Category" >';
               while ($rows=mysqli_fetch_array($res)){
               echo'<option value="'.$rows['catid'].'" >'.$rows['category_name'].'</option>\n';
               }
...
//
                        ...
                        $result =        mysqli_query($con,"update tb_products set name='$name',description='$description',category='$category',originated='$originated',price='$price',quantity='$quantity',location='$location' where productID='$get_id'") or die(mysqli_query());

                                    if($result != 0){
                                echo "<br><div class='success alert-info'><strong>Edited Successfully!</strong> </div>";
