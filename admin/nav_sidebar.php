 <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="product.php"><i class="fa fa-dashboard"></i> Home/Menu</a>
                    </li>
                    <li>
                        <a href="product.php"><i class="fa fa-gear"></i> Products</a>
                    </li>
                     <li>
                        <a href="addmoreproduct.php"><i class="fa fa-gear"></i> Add More Products</a>
                    </li>
                    <li>
                        <a href="category.php"><i class="fa fa-gear"></i> Category</a>
                    </li>
					<li>
