                           ...
                           <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <div class="alert alert-info">
								    ...
								    <ul class="breadcrumb"> 
                                           ...
                                           <li><a href="delivered.php">Delivered Orders</a><span class="divider">/</span></li>
											<li class="active">All Orders<span class="divider">/</span></li>
                                ...
                                <tbody>
                                    ...
                                    $cart_table = mysqli_query($con,"select  * from order_details ORDER BY productID DESC") or die(mysqli_error());
