                           ...
                           <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <div class="alert alert-info">
								    ...
								    <ul class="breadcrumb"> 
                                            ...
                                            <li><a href="all.php">All Orders</a><span class="divider">/</span></li>
                                ...
                                <tbody>
                                    ...
                                    $cart_table = mysqli_query($con,"select  * from order_details where status='Delivered' ORDER BY productID DESC") or die(mysqli_error());
