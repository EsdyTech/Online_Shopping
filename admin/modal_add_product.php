<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text"  required name="originated" class = "form-control" placeholder="Origin">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" required name="price"  class = "form-control" splaceholder="Price" >
                                    </div>
                                </div>
...
//
                                ...
                                $querys = mysqli_query($con,"select * from tb_products where name= '$name' && category ='$category' && originated='$originated'") or die (mysqli_error());
                    ...
                    $result =  mysqli_query($con,"insert into tb_products (name,description,category,originated,price,quantity,location)
