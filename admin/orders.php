                             ...
                             <table class="table table-striped table-bordered table-hover table-condensed" id="dataTables-example">
                                <div class="alert alert-info">
								    ...
								    <ul class="breadcrumb"> 
                                        ...
                                        <li><a href="all.php">All</a> <span class="divider">/</span></li>
                                ...
                                <tbody>
                                    ...
                                    while ($cart_row = mysqli_fetch_array($cart_table)) {
                                        ...
                                        $member_id = $cart_row['memberID'];  $qty = $cart_row['qty'];
                                        ...
                                        <tr>
										    ...
										    <td width="140"><a href="update_status.php<?php echo '?id='.$order_id; ?>&<?php  echo 'product_id='.$product_id; ?>&<?php  echo 'qty='.$qty; ?>" class="btn btn-success"><i class="fa fa-check"></i>&nbsp;Confirm Order</a></td>
